...
def resolve_runtime_variables():
    ...
    if MOJO_RUNTIME_VARNAMES.MJR_EXTENSION_FACTORY_ADDITIONS in environ:
        MOJO_RUNTIME_VARIABLES.MJR_EXTENSION_FACTORY_ADDITIONS = environ[MOJO_RUNTIME_VARNAMES.MJR_EXTENSION_FACTORY_ADDITIONS]
